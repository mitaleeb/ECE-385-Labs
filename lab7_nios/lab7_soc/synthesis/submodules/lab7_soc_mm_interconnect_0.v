...
module lab7_soc_mm_interconnect_0 (
	...
	wire   [27:0] accum_reset_s1_agent_m0_address;                                                    // accum_reset_s1_agent:m0_address -> accum_reset_s1_translator:uav_address
	...
	wire  [106:0] accum_reset_s1_agent_rf_source_data;                                                // accum_reset_s1_agent:rf_source_data -> accum_reset_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] accum_reset_s1_agent_rsp_fifo_out_data;                                             // accum_reset_s1_agent_rsp_fifo:out_data -> accum_reset_s1_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> accum_reset_s1_agent:cp_data
	...
	wire  [105:0] accum_reset_s1_agent_rp_data;                                                       // accum_reset_s1_agent:rp_data -> router_010:sink_data
