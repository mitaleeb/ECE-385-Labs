...
module lab9_soc_mm_interconnect_0 (
	...
	wire  [106:0] aes_decryption_core_0_aes_slave_agent_rf_source_data;                               // AES_Decryption_Core_0_AES_Slave_agent:rf_source_data -> AES_Decryption_Core_0_AES_Slave_agent_rsp_fifo:in_data
	...
	wire  [106:0] aes_decryption_core_0_aes_slave_agent_rsp_fifo_out_data;                            // AES_Decryption_Core_0_AES_Slave_agent_rsp_fifo:out_data -> AES_Decryption_Core_0_AES_Slave_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> AES_Decryption_Core_0_AES_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // AES_Decryption_Core_0_AES_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [13:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> AES_Decryption_Core_0_AES_Slave_agent:cp_channel
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> otg_hpi_reset_s1_agent:cp_valid
	wire  [105:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> otg_hpi_reset_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // otg_hpi_reset_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [13:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> otg_hpi_reset_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> otg_hpi_reset_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> otg_hpi_reset_s1_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> otg_hpi_w_s1_agent:cp_data
	...
	wire  [105:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> otg_hpi_cs_s1_agent:cp_data
	...
	wire  [105:0] aes_decryption_core_0_aes_slave_agent_rp_data;                                      // AES_Decryption_Core_0_AES_Slave_agent:rp_data -> router_002:sink_data
	...
	wire          otg_hpi_reset_s1_agent_rp_valid;                                                    // otg_hpi_reset_s1_agent:rp_valid -> router_009:sink_valid
	wire  [105:0] otg_hpi_reset_s1_agent_rp_data;                                                     // otg_hpi_reset_s1_agent:rp_data -> router_009:sink_data
	wire          otg_hpi_reset_s1_agent_rp_ready;                                                    // router_009:sink_ready -> otg_hpi_reset_s1_agent:rp_ready
	wire          otg_hpi_reset_s1_agent_rp_startofpacket;                                            // otg_hpi_reset_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          otg_hpi_reset_s1_agent_rp_endofpacket;                                              // otg_hpi_reset_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [105:0] otg_hpi_w_s1_agent_rp_data;                                                         // otg_hpi_w_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [105:0] otg_hpi_cs_s1_agent_rp_data;                                                        // otg_hpi_cs_s1_agent:rp_data -> router_011:sink_data
	...
	wire          otg_hpi_reset_s1_agent_rdata_fifo_src_valid;                                        // otg_hpi_reset_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] otg_hpi_reset_s1_agent_rdata_fifo_src_data;                                         // otg_hpi_reset_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          otg_hpi_reset_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_007:in_0_ready -> otg_hpi_reset_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> otg_hpi_reset_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> otg_hpi_reset_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // otg_hpi_reset_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> otg_hpi_reset_s1_agent:rdata_fifo_sink_error
